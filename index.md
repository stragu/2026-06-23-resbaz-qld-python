...
venue: "ResBaz QLD 2026 - Python"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Room E557, QUT Kelvin Grove, Meanjin (Brisbane)"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "-27.451980"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "153.017164"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "23-24 June 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30 am - 5:30 pm (day 1), 9:00 am - 12:30 pm (day 2)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Cameron West", "Lachlan McKinnie", "Kasia Koziara", "Joanna Salerno"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Ade Adeyinka", "Justin Scott", "Rafael Couto", "Riad Akhundov", "Ooroosa Ali", "Vicki Thomson"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["s.guillou@uq.edu.au","resbaz@qcif.edu.au"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<p>
Welcome to the Carpentries Python workshop at <a href="https://resbaz.github.io/resbaz2026qld">ResBaz QLD 2026</a>! We will follow the "<a href="https://swcarpentry.github.io/python-novice-gapminder/index.html">Plotting and Programming in Python</a>" curriculum.
</p>
<p>
